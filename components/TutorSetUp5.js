...
export default function TutorSetUp5({navigation}) {
        ...
        <View style={styles.container}>
            ...
            <Image
                ...
                <View styles={styles.bioContainer}>
                    ...
                    <TextInput
                        label='Short Bio'
                        placeholder='e.g, I enjoy teaching coding and simplifying tough concepts.'
                        mode='outlined'
                        multiline={true}
                        numberOfLines={4}
                        value={shortBio}
                ...
                <View styles={styles.bioContainer}>
                    ...
                    <TextInput
                        label='Short Bio'
                        placeholder='e.g, Tutored juniors in Math for 2 years.'
                        mode='outlined'
                        multiline={true}
                        numberOfLines={4}
                        value={shortBio}
